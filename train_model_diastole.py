...
path_train = 'Training_arrays/Diastole/'
path_val = 'Validation_arrays/Diastole/'
pathModel = 'DiastoleModel/'
pathLog = 'DiastoleLog/'

batchsize = 4

n_epochs, n_iter_train, n_iter_val = 400, int(491 / batchsize), int(194 / batchsize)
data_train = data_generator(path_train, batchsize=batchsize, mode='Diastole', shuffle=True, train=True)
data_val = data_generator(path_val, batchsize=batchsize, mode='Diastole', shuffle=False, train=False)
